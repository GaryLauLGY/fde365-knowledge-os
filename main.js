  ...
  "blueprint.json"(exports2, module2) {
    module2.exports = {
      ...
      folders: [
        ...
        ".agents/skills",
        ".agents/skills/安全检查",
        ".agents/skills/安全检查/agents",
        ".agents/skills/安全检查/references",
        ".agents/skills/安全检查/scripts",
        ".agents/skills/保存进度",
        ".agents/skills/保存进度/agents",
        ".agents/skills/保存进度/references",
        ".agents/skills/边做边学",
        ".agents/skills/边做边学/agents",
        ".agents/skills/边做边学/references",
        ".agents/skills/材料入库",
        ".agents/skills/材料入库/agents",
        ".agents/skills/材料入库/references",
        ".agents/skills/查询知识",
        ".agents/skills/查询知识/agents",
        ".agents/skills/查询知识/references",
        ".agents/skills/传播复盘",
        ".agents/skills/传播复盘/agents",
        ".agents/skills/传播复盘/references",
        ".agents/skills/导出会话",
        ".agents/skills/导出会话/agents",
        ".agents/skills/导出会话/references",
        ".agents/skills/导出会话/scripts",
        ".agents/skills/定义概念",
        ".agents/skills/定义概念/agents",
        ".agents/skills/定义概念/references",
        ".agents/skills/读者匹配",
        ".agents/skills/读者匹配/agents",
        ".agents/skills/读者匹配/references",
        ".agents/skills/多角度讨论",
        ".agents/skills/多角度讨论/agents",
        ".agents/skills/多角度讨论/references",
        ".agents/skills/公众号排版",
        ".agents/skills/公众号排版/agents",
        ".agents/skills/公众号排版/references",
        ".agents/skills/公众号排版/scripts",
        ".agents/skills/恢复进度",
        ".agents/skills/恢复进度/agents",
        ".agents/skills/恢复进度/references",
        ".agents/skills/记录决定",
        ".agents/skills/记录决定/agents",
        ".agents/skills/记录决定/references",
        ".agents/skills/检查表达",
        ".agents/skills/检查表达/agents",
        ".agents/skills/检查表达/references",
        ".agents/skills/检查段落",
        ".agents/skills/检查段落/agents",
        ".agents/skills/检查段落/references",
        ".agents/skills/检查更新",
        ".agents/skills/检查更新/agents",
        ".agents/skills/检查更新/references",
        ".agents/skills/建库采访",
        ".agents/skills/建库采访/agents",
        ".agents/skills/建库采访/references",
        ".agents/skills/交易分析",
        ".agents/skills/交易分析/agents",
        ".agents/skills/交易分析/references",
        ".agents/skills/开始使用",
        ".agents/skills/开始使用/agents",
        ".agents/skills/开始使用/references",
        ".agents/skills/明确目标",
        ".agents/skills/明确目标/agents",
        ".agents/skills/明确目标/references",
        ".agents/skills/内容审核",
        ".agents/skills/内容审核/agents",
        ".agents/skills/内容审核/references",
        ".agents/skills/内容审核/references/modes",
        ".agents/skills/内容写作",
        ".agents/skills/内容写作/agents",
        ".agents/skills/内容写作/references",
        ".agents/skills/内容写作/references/modes",
        ".agents/skills/确定焦点",
        ".agents/skills/确定焦点/agents",
        ".agents/skills/确定焦点/references",
        ".agents/skills/商业诊断",
        ".agents/skills/商业诊断/agents",
        ".agents/skills/商业诊断/references",
        ".agents/skills/商业诊断/references/modes",
        ".agents/skills/设计开头",
        ".agents/skills/设计开头/agents",
        ".agents/skills/设计开头/references",
        ".agents/skills/生成标题",
        ".agents/skills/生成标题/agents",
        ".agents/skills/生成标题/references",
        ".agents/skills/生成选题",
        ".agents/skills/生成选题/agents",
        ".agents/skills/生成选题/references",
        ".agents/skills/推进一步",
        ".agents/skills/推进一步/agents",
        ".agents/skills/推进一步/references",
        ".agents/skills/项目设置",
        ".agents/skills/项目设置/agents",
        ".agents/skills/项目设置/references",
        ".agents/skills/研究对标",
        ".agents/skills/研究对标/agents",
        ".agents/skills/研究对标/references",
        ".agents/skills/研究对标/references/modes",
        ".agents/skills/整理报告",
        ".agents/skills/整理报告/agents",
        ".agents/skills/整理报告/references",
        ".agents/skills/整理问题",
        ".agents/skills/整理问题/agents",
        ".agents/skills/整理问题/references",
        ".agents/skills/整理资产",
        ".agents/skills/整理资产/agents",
        ".agents/skills/整理资产/references",
        ".agents/skills/整理资产/scripts",
        ".agents/skills/知识体检",
        ".agents/skills/知识体检/agents",
        ".agents/skills/知识体检/references",
        ".fde",
        ".fde/indexes",
        ".fde/logs",
        ".fde/quarantine",
...
// skill-names.js
var require_skill_names = __commonJS({
  "skill-names.js"(exports2, module2) {
    var LEGACY_SKILL_NAMES = Object.freeze({
      "fde-start": "开始使用",
      "fde-interview": "建库采访",
      "fde-ingest": "材料入库",
      "fde-export": "导出会话",
    ...
    var SKILL_NAMES = Object.freeze(Object.values(LEGACY_SKILL_NAMES));
    var legacyPattern = new RegExp(`(?<![a-z0-9_-])(?:${Object.keys(LEGACY_SKILL_NAMES).join("|")})(?![a-z0-9_-])`, "gi");
    ...
    module2.exports = { LEGACY_SKILL_NAMES, SKILL_NAMES, canonicalSkillName, normalizeSkillMentions };
  }
});
...
var require_fde_workspace_view_base = __commonJS({
  "fde-workspace-view-base.js"(exports2, module2) {
    ...
    var { canonicalSkillName, normalizeSkillMentions } = require_skill_names();
    module2.exports = function createFDEBaseView({
      ...
      class FDEBaseView extends ItemView2 {
        ...
        get assistantDraft() {
          return normalizeSkillMentions(this.assistantSession.draft);
        }
...
${paths}`;
              await this.render();
              this.focusAssistantConversation();
              new Notice2(`已导入 ${imported.length} 份发布数据，并在右侧对话填入 /传播复盘`);
            } catch (error) {
...
插件可能会在“本地运行上下文”中附加已经读取的配置与技能合同；直接使用这些内容。需要时使用本地工具检查 Vault。${inboxCompletionProtocol}`,
        ...
        async renderAssistant(app, data) {
          ...
          body.createEl("p", {
            text: executionMode === "yolo" ? "YOLO 模式：Agent 在当前 Vault 内自动执行，不再逐次批准。" : "需要批准：Agent 可读取当前 Vault、运行技能；命令和写入会向你确认。",
        ...
        async renderMain(main, data) {
          ...
          const importFiles = async (fileList) => {
            ...
            try {
              ...
              new Notice2(`已收录 ${imported.length} 个文件；等待你决定是否运行 /材料入库`);
              await this.render();
            } catch (error) {
      ...
      class FDESkillsView extends FDEBaseView {
        ...
        async renderMain(main, data) {
          ...
          SKILLS.filter((skill2) => skill2.group === this.selectedGroup).forEach((skill2) => {
            ...
            const text = button.createDiv();
            text.createEl("strong", { text: skill2.name });
            text.createSpan({ text: skill2.output });
...
var require_fde_workspace = __commonJS({
  "fde-workspace.js"(exports2, module2) {
    ...
    function assistantHistoryTopic(frontmatter = {}) {
      ...
      const normalized = prompt.replace(/^\s*[/／]([^\s]+)\s*/u, (match, name) => canonicalSkillName(name) ? "" : match).replace(/\[\[([^\]|]+)(?:\|[^\]]+)?\]\]/g, "$1").replace(/[`*_>#-]+/g, " ").replace(/\s+/g, " ").trim();
      if (normalized) {
...
${item.excerpt || ""}`)
    ...
    function buildBaseInstructions(request, vaultPath, knowledgeRoot) {
      const { SKILL_NAMES } = require_skill_names();
...
var AIKnowledgeOSSettingTab = class extends PluginSettingTab {
  ...
  display() {
    ...
    new Setting(containerEl).setName("界面主题").setDesc("跟随 Obsidian 的深浅色、强调色和字体；请在 Obsidian「外观」中调整。");
    ...
    new Setting(containerEl).setName("技能执行规则").setDesc(`${FDEWorkspace.SKILLS.length} 个项目技能位于知识库 .agents/skills；执行时使用当前 Provider，并要求先读取对应 SKILL.md 合同。`);
    ...
    new Setting(containerEl).setName("统计数据来源").setDesc("只读取六类资产的真实文件、来源字段、未知项、内容阶段、链接和项目技能部署状态。");
  }
};
module.exports = class AIKnowledgeOSPlugin extends Plugin {
  ...
  getWorkspaceView() {
    return this.getWorkspaceLeaves()[0]?.view || null;
  }
  getDashboard() {
  ...
  async activateWorkspace(page = "dashboard") {
    if (!this.workspaceOpening) {
      this.workspaceOpening = (async () => {
        ...
        await leaf2.setViewState({ type: DASHBOARD_VIEW_TYPE, state: { page }, active: true });
        return leaf2;
      })();
    }
    ...
    try {
      ...
      if (this.workspaceOpening === opening) this.workspaceOpening = null;
    }
  ...
  async activateView() {
    return this.activateWorkspace("dashboard");
  }
  async activateInbox() {
    return this.activateWorkspace("inbox");
  }
  async activateKnowledge() {
    return this.activateWorkspace("libraries");
  }
  async activateGraph() {
    return this.activateWorkspace("network");
  }
  async activateProjects() {
    return this.activateWorkspace("content");
  }
  async activateAgents() {
    return this.activateWorkspace("skills");
  }
  async activateAnalytics() {
    return this.activateWorkspace("health");
  }
